...
Also, in this class, students are expected to experience how to apply LLM (large language model) such as ChatGpt to improve efficiency of software development tasks like documentation, test code generation, and so on.
